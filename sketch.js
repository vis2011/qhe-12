...
var backButton, nextButton ,  gc5 ,gc6 ,gc7 ,gc8 , gc9 , gc10;
...
var b1img ,b2img ,ddr2 , ddr2img, b3img, b4img ,b5img ,b6img ,b7img,b8img ,b9img ,b10img , b11img , gameoverbg , restart ,gc1img , gc2img , gc3img ,gc4img ,gc5img , gc6img , gc7img ,gc8img ,gc9img , gc10img ;
...
function preload() {
  ...
  gc5img = loadImage("gc-4.png");
    gc6img = loadImage("gc-5.png");
  gc7img = loadImage("gc-6.png");
    gc8img = loadImage("gc-7.png");
  gc9img = loadImage("gc-8.png");
    gc10img = loadImage("gc-9.png");
  gameoverbg = loadImage("gameover.jpg");
  wallimg = loadImage("wall.png");
  pl2bg =  loadImage("pl2bg.png");
...
function setup() {
  ...
  wall = createSprite(width /2 , height / 2 , 1600, windowHeight +800);
  wall.addImage(wallimg);
  wall.visible = false;
  wall.velocityY=-7;
  wall.class = "bgimg";

    gc6 = createSprite(windowWidth/2 + 600 , 60 , 30 , 30);
  gc6.addImage(gc1img);
  gc6.visible = false;

  gc7 = createSprite(windowWidth/2 + 600 , 60 , 30 , 30);
  gc7.addImage(gc2img);
    gc7.visible = false;

  gc8 = createSprite(windowWidth/2 + 600 , 60 , 30 , 30);
  gc8.addImage(gc3img);
    gc8.visible = false;

      gc9 = createSprite(windowWidth/2 + 600 , 60 , 30 , 30);
  gc9.addImage(gc4img);
    gc9.visible = false;

  gc10 = createSprite(windowWidth/2 + 600 , 60 , 30 , 30);
  gc10.addImage(gc5img);
    gc10.visible = false;
  ...
  spineGroup.add(spine)
    ...
    switch(rand) {
      ...
      default: break;
        ...
        clueobject1=createSprite(randy1, 20 , 20 ,20);
clueobject1.size = 0.2;

clueobject1.velocityY=2;

clueobject1.velocityY = 2;

clueobjGroup.add(clueobject1)
    
    //generate random clueobject
    var rand = Math.round(random(1,5));
    switch(rand) {
      case 1: clueobject1.addImage(gcimg);
              break;
      case 2: clueobject1.addImage(gcimg);
              break;
      case 3: clueobject1.addImage(gcimg);
              break;
      case 4: clueobject1.addImage(gcimg);
              break;
      case 5: clueobject1.addImage(gcimg);
              break;
      default: break;
    }
  }
